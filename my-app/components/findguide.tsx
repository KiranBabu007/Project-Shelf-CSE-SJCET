      ...
      <div className="space-y-4">
        <div className="sketch-border-thin flex items-center gap-3 p-4 bg-gray-50">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Try a different description</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <div className="sketch-border-thin flex items-center gap-3 p-4 bg-orange-50">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-wider text-gray-500">Recommended Guide</p>
          </div>
        </div>
        <div className="sketch-border-thin p-4 bg-white">
          ...
          <div className="space-y-2">
            {similarProjects.slice(0, 3).map((project, idx) => (
              <div key={idx} className="sketch-border-thin p-3 bg-white">
                ...
                {project.year && (
                  <span className="inline-block mt-1 text-[10px] font-bold uppercase tracking-wider text-gray-500 bg-gray-100 px-2 py-0.5 rounded-sm border border-gray-200">
                    {project.year}
                  </span>
                )}
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 right-4 w-14 h-14 rounded-full bg-orange-500 text-white flex items-center justify-center z-50 sketch-border hover:bg-orange-600 transition-colors"
        id="find-guide-fab"
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          ...
          <div className="w-full max-w-md max-h-[85vh] bg-white border-[1.5px] border-gray-900 shadow-[3px_3px_0px_#222] rounded-sm relative z-10 overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
            {/* Header */}
            <div className="border-b border-gray-900 px-5 py-4 flex items-center justify-between bg-gray-50 shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-caveat text-xl font-bold text-gray-900">
                    Find My Guide
                  </h3>
                ...
                <div className="space-y-5">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full min-h-[120px] p-3 text-sm border-[1.5px] border-gray-900 rounded-sm shadow-[1px_1px_0px_#222] resize-none focus:outline-none focus:shadow-[2px_2px_0px_#222] transition-shadow placeholder:text-gray-400"
