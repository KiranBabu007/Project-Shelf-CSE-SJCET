const projectsData = {
  ...
  "2019-2020": [
    ...
    },
    {
      ...
      description: "A system leveraging GIS and cutting-edge technologies to assist in flood rescue operations and accurate zone mapping for disaster management.",
  ...
  },
  {
      ...
      description: "A translator tool designed to bridge communication gaps for the deaf-mute community by converting sign language into text or speech.",
    ...
    ,
    "2020-2021": [
    { id: 1, title: "Automated Bus Scheduling", description: "A solution for automated bus scheduling and optimization", students: "Anandu R, Aishwarya Michael", supervisor: "Prof. Kishore Sebastian", tags: ["Transportation", "Automation"] },
    { id: 2, title: "Virus Tracking System", description: "A system to track virus spread and analyze data", students: "Alwin Varghese, Anu Justin, Ashly Sibichan, Augustine S Aykara", supervisor: "Prof. Smitha Jacob", tags: ["Health Monitoring", "Data Analysis", "Tracking"] },
    { id: 3, title: "Integrated Platform for Online Education", description: "A platform for managing online education needs", students: "Athira Gopinath, Felix V James, Johan Issac, Justin Johny Mathew", supervisor: "Prof. Mereen Thomas", tags: ["Education", "Online Platform"] },
    { id: 4, title: "Shared Parking System", description: "A system to share and manage parking spaces efficiently", students: "Amel John, Alan K George, Allen Jose, Joseph Mathew", supervisor: "Prof. Bino Thomas", tags: ["Parking Management", "IoT"] },
    { id: 5, title: "Handwriting Recognition System Using Deep Learning", description: "A handwriting recognition system leveraging deep learning", students: "Alex Joseph, Athira M Nair, Blessil Bose, Chrissie Aldo", supervisor: "Dr. Praseetha V. M", tags: ["Deep Learning", "Image Processing"] },
    { id: 6, title: "Skin Disease Detection", description: "An AI-based system for detecting skin diseases", students: "Don Basil Peter, Alwin Sonny, Jerin Jose Reeni, Bijesh Biju", supervisor: "Prof. Jikku Thomas", tags: ["Healthcare", "AI", "Image Processing"] },
    { id: 7, title: "Spot-U", description: "A mobile app for real-time parking spot tracking", students: "Akhil K Anil, David Pious, Joseph Alen Shaji, Ankith Suresh", supervisor: "Prof. Angitha George", tags: ["Parking", "App Development"] },
    { id: 8, title: "SpiderBot", description: "A robotic spider for inspection tasks", students: "Christin Mathew, Alen Joy, Jobson P Varghese, Jeff Mathew", supervisor: "Prof. Sinu Maria Kurian", tags: ["Robotics", "IoT"] },
    { id: 9, title: "Storing Patients’ Medical Records Using Blockchain", description: "A blockchain solution for securing medical records", students: "Ashas P Uday, Jobin K Kurian, Abey Jose Sebastian, Abin Mathew", supervisor: "Prof. Divya Sunny", tags: ["Blockchain", "Healthcare"] },
    { id: 10, title: "VR Kerala", description: "A virtual reality experience showcasing Kerala", students: "Amal Sebastian", supervisor: "Prof. Sarju S.", tags: ["Virtual Reality", "Tourism"] },
    { id: 11, title: "LeFarm - One Step Platform for Farmers", description: "A digital platform for farmers to connect and manage activities", students: "Akshara Mariya Josy, Alka Brigit Senson, Amelin Thomas, Aysha Nazarudeen", supervisor: "Prof. Suma R.", tags: ["Agriculture", "App Development"] },
    { id: 12, title: "AR Classroom for Teachers and Students", description: "An AR-based classroom experience for education", students: "Christy Varghese, Amal Anto, Hanna Elsa Reni George, Jiya George", supervisor: "Prof. Bino Thomas", tags: ["Augmented Reality", "Education"] },
    { id: 13, title: "We4You", description: "A social platform connecting people in need with helpers", students: "Albin Francis, Amala Saji, Aparna Thomas, Dhaya Mathew", supervisor: "Prof. Mereen Thomas", tags: ["Social Platform", "Community Support"] },
    { id: 14, title: "Securing Healthcare Portal", description: "A portal for securing patient data and healthcare services", students: "Indu Cyriac, Divya Shaji Thomas, Avinash A Panicker", supervisor: "Prof. Akshara Sasidharan", tags: ["Healthcare", "Cybersecurity"] },
    { id: 15, title: "Game Development", description: "Development of an engaging and interactive game", students: "Clement P Tom, Dona Tom, James Jacob Jose, Joseph Thomas", supervisor: "Prof. Prince Abraham", tags: ["Game Development", "Interactive Media"] },
    { id: 16, title: "Automatic Bus Scheduling and Travel Companion", description: "A system to automate bus scheduling and provide a travel companion service", students: "Kennith Feryl Philips, Smitha John", supervisor: "Prof. Kishore Sebastian", tags: ["Transportation", "Automation"] },
    { id: 17, title: "Intelligent Question Answering Using Deep Learning", description: "An intelligent system to answer questions using deep learning techniques", students: "Sebin Byju, Roval Benny, Royal Benny, Richu Joy", supervisor: "Dr. Gemini George", tags: ["Deep Learning", "AI"] },
    { id: 18, title: "Raptor", description: "A project focused on advanced robotic systems", students: "Megan Jacob, Sandra Stephen, Santhosh Thomas, Sandeep Salmon", supervisor: "Prof. Jikku Thomas", tags: ["Robotics", "Automation"] },
    { id: 19, title: "Digi-Valuate", description: "A digital tool for asset valuation", students: "Mileen Sebastian, Rachel Kunjumon, Samaanta Shaji", supervisor: "Prof. Suma R", tags: ["Asset Management", "Digital Tool"] },
    { id: 20, title: "Quality Grading of Fruits and Vegetables", description: "A system to assess the quality of fruits and vegetables using AI", students: "Teresa George, Respa R S, Rhea Salih, Shibreeze K Sebastian", supervisor: "Dr. Sruthy S", tags: ["AI", "Agriculture"] },
    { id: 21, title: "Early Fire Detection", description: "An IoT-based system for early detection of fire hazards", students: "Rithin Jose, Romal Roy, Roop Saji, Rose Maria M T", supervisor: "Prof. Ashly Thomas", tags: ["IoT", "Fire Safety"] },
    { id: 22, title: "Ride Sharing Platform", description: "A platform for efficient ride sharing", students: "Leion Sunny, Riya Theresa Abraham, Saranya S, Chrisbin Sunny", supervisor: "Dr. Joby P.P", tags: ["Transportation", "App Development"] },
    { id: 23, title: "Game Development Using Spark AR Docile", description: "A game development project using Spark AR", students: "Santhul Joseph, Rony Thomas, Pheleena V Thomas, Natha B", supervisor: "Prof. Prince V Jose", tags: ["Game Development", "Augmented Reality"] },
    { id: 24, title: "Vehicle Accident Detection with Emergency Notification", description: "A system to detect vehicle accidents and notify emergency services", students: "Suneer Methar, Wasim Saju, Megha Sunny, Sandra Raju", supervisor: "Dr. Gemini George", tags: ["AI", "Safety"] },
    { id: 25, title: "IoT Assisted Device Controlling System", description: "A system to control devices using IoT technology", students: "Kichu Sebastian, Justine Francis, Stebin Paul, Subin M", supervisor: "Prof. Ashly Thomas", tags: ["IoT", "Automation"] },
    { id: 26, title: "AgroSight", description: "A solution for smart farming and agricultural monitoring", students: "Nidhun S, Thomas Alphonse Benny, Vaishnavi S, Nidhina Tom", supervisor: "Prof. Nimmy Joshy", tags: ["Agriculture", "IoT"] },
    { id: 27, title: "VR Kerala", description: "A virtual reality experience to promote Kerala tourism", students: "Lija Alex, S Nikhit, Muhammed Aftab N Sait, Remya Raju", supervisor: "Dr. Praseetha V.M", tags: ["Virtual Reality", "Tourism"] },
    { id: 28, title: "Building a Decentralized Economy Using Blockchain", description: "A project to create a decentralized economy using blockchain technology", students: "Alwin K Scaria, Shinu Shaju, Teena Tomy", supervisor: "Prof. Prince Abraham", tags: ["Blockchain", "Economy"] },
    { id: 29, title: "Third Eye", description: "A smart assistant system for visually impaired individuals", students: "Vimal Jose, Solomon Joyce, Sonu Kuruvilla Babychan, Nibin Sabu Thomas", supervisor: "Prof. Anna N Kurian", tags: ["Assistive Technology", "AI"] },
    { id: 30, title: "Medi-Cloud", description: "A cloud-based solution for managing medical data", students: "Kiran Xavier, Praveena P Prabhu, Rohann Tom Soney, Sanjay Suresh", supervisor: "Prof. Angitha George", tags: ["Healthcare", "Cloud Computing"] }
]
    ,
    "2021-2022":[
        {
        ...
        },
        {
            ...
            description: "Not available",
            students: "Noble Mathew, Arjun Shibu, Anitta Mary Thomas, Stefhina George",
            supervisor: "Prof. Smitha Jacob",
        ...
        },
        {
            ...
            title: "IBH App",
            description: "Not available",
            students: "Christeena John, Raniya Rachel Varghese, Ritta Sara Thomas, Ryan Maria Sunil",
            supervisor: "Prof. Bino Thomas",
        ...
        },
        {
            ...
            title: "Guide My Way",
            description: "Not available",
            students: "Martin Francis, Teena Thomas, Sebin Benny, Christeen Maria Philip",
            supervisor: "Prof. Bino Thomas",
        ...
        },
        {
            ...
            title: "Helping Hands",
            description: "Not available",
            students: "Abin S Bijo, Benson Bastian Siby, Fibin Pious, Sam Dominic Benjamin",
        ...
        },
        {
            ...
            description: "Not available",
            students: "Shyam Mathew, Varun V Nair, Praful Sanal Kumar, Rajath Alphonse",
            supervisor: "Prof. Angitha George",
        ...
        },
        {
            ...
            title: "We Serve",
            description: "Not available",
            students: "Amal Alphonse Mathew, Suhail Shamsuddin, Sojan Philip, Mishell Mariya Joseph",
            supervisor: "Prof. Jikku Thomas",
        ...
        },
        {
            ...
            title: "PIREC",
            description: "Not available",
            students: "Joseph Thomas, Meljo Sunny, Mithun Varghese Mathew, Varkey Martin",
            supervisor: "Prof. Jibin Philip",
        ...
        },
        {
            ...
            description: "Not available",
            students: "Amrutha M Nair, Anish Mathew Sunny, Anita Mariya Babu, Devi Nair",
    ...
    "2022-2023": [
        {
            ...
            description: "A system leveraging the YOLO algorithm for real-time detection of animal intrusions, enhancing safety in farms and restricted areas.",
        ...
        },
        {
            ...
            description: "An IoT-based system for continuous heart monitoring, providing real-time data and alerts to healthcare providers.",
        ...
        },
        {
            ...
            description: "An assistive learning application tailored for children with Down Syndrome, enhancing cognitive skills through interactive tools.",
        ...
        },
        {
            id: 4,
            title: "SJCET Arena",
            description: "A cloud-based platform for managing campus events with real-time IoT integration.",
        ...
        },
        {
            ...
            description: "An augmented reality learning platform gamified to enhance student engagement and interactive education.",
        ...
        },
        {
            ...
            description: "A multi-functional super-app framework that integrates various applications, customizable to user preferences.",
        ...
        },
        {
            ...
            description: "An IoT-enabled system to enhance security and tracking for school buses, ensuring student safety.",
        ...
        },
        {
            ...
            description: "A health monitoring app integrated with a wearable health band for real-time health tracking and alerts.",
        ...
        },
        {
            ...
            description: "An image processing tool to detect lanes and curves for advanced driver assistance systems.",
        ...
        },
        {
            ...
            description: "An AI-powered tool that translates speech into Indian Sign Language (ISL), bridging communication gaps.",
        ...
        },
        {
            ...
            description: "A deep learning model employing VGG-16 and DenseNet architectures for accurate brain tumor detection.",
        ...
        },
        {
            ...
            description: "A system for identifying and detecting forged images using deep learning and advanced image processing techniques.",
        ...
        },
        {
            ...
            description: "A machine learning solution for early detection of Alzheimer's disease and assistance for patients.",
        ...
        },
        {
            ...
            description: "An offline communication app designed to facilitate peer-to-peer messaging without internet dependency.",
        ...
        },
        {
            ...
            description: "A framework utilizing deep learning algorithms for effective classification and detection of malware.",
        ...
        },
        {
            ...
            description: "A system combining IoT and blockchain to ensure secure and transparent vaccine distribution tracking.",
        ...
        },
        {
            ...
            description: "A robust two-factor authentication system enhancing security for digital platforms.",
        ...
        },
        {
            ...
            description: "A collaborative software toolkit integrated with machine learning for streamlined teamwork and project management.",
        ...
        },
        {
            ...
            description: "A machine learning-based platform for analyzing and predicting stock market trends.",
        ...
        },
        {
            ...
            description: "A robotic claw controlled by motion detection for industrial and assistive applications.",
        ...
        },
        {
            ...
            description: "A machine learning framework to detect and mitigate Distributed Denial-of-Service (DDoS) attacks.",
        ...
        },
        {
            ...
            description: "An IoT-enabled smart bike system focused on improving rider safety and reducing accidents.",
        ...
        },
        {
            ...
            description: "A convolutional neural network (CNN) model for early and accurate detection of skin cancer.",
        ...
        },
        {
            ...
            description: "A natural language processing (NLP) tool to extract insights from online product reviews for better decision-making.",
        ...
        },
        {
            ...
            description: "A blockchain-based decentralized platform for secure and transparent fundraising activities.",
        ...
        },
        {
            ...
            description: "A secure file storage solution leveraging hybrid encryption techniques for cloud computing.",
        ...
        },
        {
            ...
            description: "A machine learning-powered design tool for creating and simulating robotic systems.",
        ...
        },
        {
            ...
            description: "A decentralized transportation app leveraging blockchain for peer-to-peer ride-sharing services.",
        ...
        },
        {
            ...
            description: "A machine learning-enabled system for efficient management and monitoring of transportation fleets.",
        ...
        },
        {
            ...
            description: "An AI-based video surveillance system designed to ensure the safety and care of elderly individuals.",
        ...
        },
        {
            ...
            description: "Smart glasses featuring real-time speech recognition and transcription to assist individuals with hearing impairments.",
        ...
        },
        {
            id: 32,
            title: "Smart Basket",
            description: "An intelligent shopping basket utilizing machine learning to enhance the e-commerce shopping experience.",
    ...
    "2024": [
        { id: 5, title: "Curently", description: "A Household electricity consumption monitoring solution", students: "Kiran Babu,Indrajith S Nair,Sidharth Manikuttan,Anit Thomas", supervisor: "Prof. Jikku Thomas", tags: ["IoT", "App Development", "FireBase", "React Native"] },
