...
const ProjectShelf = () => {
  ...
  const [selectedYear, setSelectedYear] = useState<string>(
    urlYear && Object.keys(projectsData).includes(urlYear) ? urlYear : DEFAULT_YEAR
  );
  ...
  const [searchOpen, setSearchOpen] = useState(!!urlSearch);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#faf8f4]">
      ...
      <a
        href="#projects-grid"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[100] focus:px-4 focus:py-2 focus:bg-white focus:border-2 focus:border-gray-900 focus:rounded-sm focus:text-sm focus:font-medium"
      >
        Skip to projects
      </a>
      ...
      {/* ============ NAVBAR ============ */}
      <nav
        className={`bg-[#faf8f4]/95 backdrop-blur-sm sticky top-0 z-40 transition-shadow duration-200 ${
          scrolled ? "shadow-[0_1px_3px_rgba(0,0,0,0.1)] border-b border-gray-200/60" : ""
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="navbar-sketch-box flex items-center gap-3 bg-white">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-orange-500 border-[1.5px] border-[#222] text-white font-bold text-lg shadow-[1px_1px_0px_#222]">
                S
              </div>
              <div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {searchOpen && (
                <div className="relative" id="search-bar">
                  ...
                  <Input
                    ...
                    className="pl-8 pr-8 w-[180px] sm:w-[260px] h-9 text-sm text-gray-900 border-[1.5px] border-[#222] rounded-[3px] shadow-[1px_1px_0px_#222] bg-white"
                    value={searchTerm}
                  ...
                  {searchTerm && (
                    <button
                      onClick={clearSearch}
                      className="absolute right-2 top-2.5 text-gray-500 hover:text-gray-900"
              ...
              <button
                ...
                className="btn-sketch-orange flex items-center gap-2 text-sm h-9 px-3 sm:px-4"
              ...
              <button
                ...
                className="btn-sketch-outline flex items-center gap-2 text-sm h-9 px-3 sm:px-4 relative"
                id="download-btn"
              >
                {exportFeedback ? (
                  <>
        ...
        <section className="py-14 sm:py-20 lg:py-24 relative overflow-hidden bg-[#faf8f4]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center text-center relative">
              <span
                className="absolute -left-2 sm:left-4 lg:left-12 top-0 text-orange-300/50 sm:text-orange-300/70 font-caveat text-5xl sm:text-7xl font-bold leading-none select-none"
              ...
              <Cpu
                className="absolute -right-2 sm:right-4 lg:right-12 bottom-0 w-12 h-12 sm:w-20 sm:h-20 text-gray-300/40 sm:text-gray-300/60"
                strokeWidth={0.8}
                aria-hidden="true"
        ...
        <section className="pb-14">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div className="stat-card-blue p-6 rotate-[-0.4deg]">
              ...
              <div className="stat-card-green p-6 rotate-[0.3deg]">
                <div className="flex items-center justify-between mb-3">
              ...
              <div className="stat-card-cream p-6 rotate-[-0.25deg]">
                <div className="flex items-center justify-between mb-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-center mb-10 gap-4">
              ...
              <div className="flex items-center gap-3">
                {searchTerm && !isEmptyYear && (
                  <button
                    onClick={clearSearch}
                    className="text-xs text-gray-600 bg-gray-100 px-2.5 py-1 rounded-sm border border-gray-300 hover:bg-gray-200 transition-colors flex items-center gap-1.5"
                  >
                    {filteredProjects.length} found for &ldquo;{searchTerm}&rdquo;
                    <X className="h-3 w-3" />
                  </button>
                )}
                <Select
                ...
                >
                  <SelectTrigger
                    className="bg-white text-sm font-bold h-10 w-[170px] text-gray-900 border-[2px] border-[#222] rounded-[3px] shadow-[2.5px_2.5px_0px_#222] hover:shadow-[3.5px_3.5px_0px_#222] hover:translate-x-[-0.5px] hover:translate-y-[-0.5px] transition-all rotate-[-0.3deg]"
                  >
                  ...
                  <SelectContent className="bg-white border-[1.5px] border-[#222] rounded-[3px] shadow-[3px_3px_0px_#222]">
              ...
              <div className="mb-8 relative overflow-hidden sketch-card border-orange-300 bg-gradient-to-r from-orange-50 via-amber-50 to-orange-50 p-6 sm:p-8">
                ...
                <div className="relative flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 mt-1 max-w-lg leading-relaxed">
            ...
            {isEmptyYear ? (
              <div className="sketch-card p-8 sm:p-12 text-center max-w-2xl mx-auto">
                ...
                <p className="text-sm text-gray-600 max-w-md mx-auto leading-relaxed mb-2">
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-1.5">
                            <span
                              className={`${getCategoryBadgeClass(category)} text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-sm`}
                            >
                              {getCategoryLabel(category)}
                            </span>
                            {project.projectType === "mini" && (
                              <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-sm bg-violet-100 text-violet-700 border border-violet-200">
                                Mini
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center gap-2 mb-4">
                          <Star className="h-3.5 w-3.5 text-gray-500 flex-shrink-0" />
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {project.tags.slice(0, 3).map((tag) => (
                            <button
                              key={tag}
                              className="tech-tag cursor-pointer hover:bg-gray-100 hover:border-gray-500"
                              onClick={(e) => {
                                e.stopPropagation();
                                handleTagClick(tag);
                              }}
                ...
                {hasMore && (
                  <div className="mt-8 text-center">
                    <button
                      ...
                      className="btn-sketch-outline text-sm"
                    >
      ...
      <footer className="py-10 bg-[#faf8f4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="navbar-sketch-box bg-white p-6 sm:p-8 rotate-[0.15deg]">
      ...
      <div className="fixed bottom-24 right-4 z-50">
        <button
          ...
          onClick={() => {
            setSearchOpen(true);
            setTimeout(() => setJoyrideRun(true), 100);
          }}
        >
          <HelpCircle className="text-orange-500 w-5 h-5" />
        </button>
      </div>
      <div id="find-guide-bot" className="fixed bottom-4 right-4 z-50">
        <FindMyGuideChat externalOpen={guideOpen} onExternalOpenChange={setGuideOpen} />
      </div>
