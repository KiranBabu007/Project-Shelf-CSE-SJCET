        ...
        <Card className="my-6 border-orange-500 border-t-4 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-slate-900 dark:border-orange-700">
          <CardHeader className="flex flex-row items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-orange-500 dark:text-orange-400 scroll-m-20 font-sans text-3xl font-bold tracking-tight">
                Project Showcase
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 dark:text-gray-300 leading-7 [&:not(:first-child)]:mt-6">
              Explore innovative projects from our talented Computer Science and
              Engineering students, pushing the boundaries of technology and
              creativity.
            </p>
          </CardContent>
        </Card>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left max-w-md">
              ...
              <p className="text-orange-700/80 dark:text-orange-300/90 leading-relaxed">
                Showcasing innovative projects from talented students at St
            ...
            <div className="flex flex-col items-center md:items-end">
              <h4 className="font-semibold text-lg mb-4 text-orange-700 dark:text-orange-300">
                Connect with me
              </h4>
                  ...
                  {[
                    {
                      icon: <Github size={20} />,
                      label: "GitHub",
                      href: "https://github.com/KiranBabu007",
                    },
                    {
                      icon: <Linkedin size={20} />,
                      label: "LinkedIn",
                      href: "https://linkedin.com/in/kiran07x",
                    },
                    {
                      icon: <Instagram size={20} />,
                      label: "Instagram",
                      href: "https://instagram.com/kr_07x",
                    },
                  ].map((social) => (
